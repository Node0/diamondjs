 ...
 *
 * Usage:
 *   route-check <routes-module.ts>   # module exporting `routes`
 *                                    # (or default export)
 *
...
/**
 * Load the consumer's routes module. TypeScript modules go through tsx's
 * tsImport (the compiled bin runs under plain node); everything else uses
